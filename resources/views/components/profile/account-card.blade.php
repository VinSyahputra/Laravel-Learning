<div x-data="{ saveProfile() { console.log('Saving account...'); } }">
    <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div class="w-full">
                <h4 class="text-lg font-semibold text-gray-800 dark:text-white/90 lg:mb-6">Account</h4>
            ...
            <button @click="$dispatch('open-profile-account-modal')"
    ...
    <!-- Edit Account Modal -->
    <x-profile.modal.edit-account :data="$data" />
</div>
