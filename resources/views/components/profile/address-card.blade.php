<div x-data="{saveProfile(){
            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $data?->country ?? '—' }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $data?->postal_code ?? '—' }}</p>
                    </div>

                    <div>
                        <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">TAX ID</p>
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $data?->tax_id ?? '—' }}</p>
                    </div>
                </div>
            </div>
    ...
    <!-- Edit Address Modal -->
    <x-profile.modal.edit-address :data="$data" />
</div>
